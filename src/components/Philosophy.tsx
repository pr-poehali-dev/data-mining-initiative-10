      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:pl-8">
            ...
            >
              Дом как
              <span className="italic"> источник</span>
              <br />
              силы
            </h2>
            ...
            >
              <p>
                Мы верим: пространство вокруг напрямую влияет на ваше состояние. Правильно устроенный дом
                восстанавливает, офис — вдохновляет. Не через дорогостоящие решения, а через точное понимание вас.
              </p>
              <p>
                Каждый проект мы разрабатываем индивидуально — учитываем ваш образ жизни, бюджет и желания.
                Премиум-качество не должно быть привилегией избранных — это наш принцип.
              </p>
            </div>
