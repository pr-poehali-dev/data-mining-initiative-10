      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Расскажите о своём доме или офисе — что сейчас не так и каким вы хотите видеть это место.
              Мы ответим, как можем помочь, и обсудим возможности под ваш бюджет.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Расскажите о вашем доме или офисе — что хотите изменить?"
                  required
                />
              </div>
              <button
