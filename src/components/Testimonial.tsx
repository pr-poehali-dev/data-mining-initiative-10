  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Я наконец понял, что значит «прийти домой» по-настоящему. Раньше дома я просто существовал — теперь восстанавливаюсь. Ребята учли всё: и бюджет, и характер, и то, как я живу. Это моё пространство.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widests uppercase text-primary-foreground/80">Дмитрий Соколов</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Квартира в Москве, 74 м²</p>
        </div>
      </div>
    </section>
  )
